...
const SCREENS: ReadonlyArray<{ screen: string; assertedIn: string }> = [
  ...
  { screen: "admin settings", assertedIn: "src/app/admin/settings/__tests__/SettingsPage.test.tsx" },
...
describe("accent budget", () => {
  ...
  it("covers thirteen core screens, and each one somewhere that runs", () => {
