...
const sanitizeAttributes = (el) => {
  for (const attr of Array.from(el.attributes)) {
    ...
    // An HTML-parsed tree keeps `foo:href` as a plain attribute name, and
    // the XML serializer writes it back out as a real prefixed attribute.
    // Namespace declarations are regenerated by the serializer.
    const drop =
      (ns === null && name.includes(":")) ||
