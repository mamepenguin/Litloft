...
_EXTENSION_TABLE: dict[str, tuple[str, str]] = {
    ...
    # Source, configuration and shell: text a machine reads. They keep a
    # `text/*` mime, so the content-write allowlist, the addon read allowlist
    # and the indexer treat them as they always have; only the bucket moves.
