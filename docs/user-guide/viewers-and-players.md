...
- Because beside is the default and the inspector starts closed on a narrower window, a video opened there can have both panels behind a closed inspector without you having pressed anything. The inspector toggle at the end of the page row brings them back.
