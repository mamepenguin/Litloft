...
- Button sizes: `h-11 w-11` (44px) in a control-bar row. Transport buttons placed **standalone over the frame** on touch step up to 56px for the secondary actions and 64px for play/pause, and take the circular dark disc above — they have no scrim of their own to sit on.
