...
class ExistingConfig:
    def __init__(self, base: Path):
        ...
        self.feat_retrieval_keywords  = 'false'
    ...
    def _load(self, base: Path):
        ...
        if sc_f.exists():
            ...
            for attr, section, key in [
                ...
                ('feat_retrieval_keywords', 'features', 'retrieval_keywords'),
            ...
            if llm_provider != 'disabled':
                ...
                if feat_vision_describe != 'false':
                    ...
                    llm_vision_model = ask(
                        ...
                        ex.llm_vision_model)
                print()
                feat_retrieval_keywords = _ask_feature_mode(
                    "Retrieval keywords",
                    "LLM-generated synonyms & alternate names for file search — helps when\n"
                    "  ASR misrecognises proper nouns; on_index sends transcript/text to LLM",
                    ex.feat_retrieval_keywords)
                print()
        ...
        if check_overwrite(sc_file):
            if not ex_file.exists():
                ...
                content = content.replace(
                    ...
                    '# Generated by configure.py — edit freely.')
                # 3-mode feature flags (quoted strings: "false" | "manual" | "on_index")
                for key, val in [
                    ...
                    ('retrieval_keywords',  feat_retrieval_keywords),
                ]:
                    content = _set_yaml_scalar(content, key, val, quoted=True)
                # 2-mode feature flag (YAML bool: true | false)
                content = _set_yaml_scalar(content, 'rag', feat_rag)
